/*
  ...
  1. New Tables
    - `tasks`
      ...
      - `task_column` (text, column position: todo/inprogress/done)
  ...
  3. Performance
    - Add indexes for user_id, task_column, position, and updated_at
...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  task_column text NOT NULL DEFAULT 'todo' CHECK (task_column IN ('todo', 'inprogress', 'done')),
...
CREATE INDEX IF NOT EXISTS tasks_task_column_idx ON tasks(task_column);
